...
public class RegistryFlag<T extends Keyed> extends Flag<T> {
    ...
    public T parseInput(FlagContext context) throws InvalidFlagFormatException {
        ...
        return Optional.ofNullable(registry.get(key))
                .orElseThrow(() -> new InvalidFlagFormatException(
                        TranslatableComponent.of("worldguard.error.flag.registry-flag.unknown-registry")
                                .args(TextComponent.of(registry.getName()), TextComponent.of(key))
                ));
    }

        ...
        if ("now".equalsIgnoreCase(input)) {
            ...
            try {
                ...
                if (parsed instanceof LocalDateTime) {
                    ...
                    throw new InvalidFlagFormatException(TranslatableComponent.of("worldguard.error.flag.timestamp-flag.unrecognized-input"));
                }
            } catch (DateTimeParseException ignored) {
                throw new InvalidFlagFormatException(TranslatableComponent.of("worldguard.error.flag.timestamp-flag.expected-now-or-iso8601"));
            }
        }
    }
